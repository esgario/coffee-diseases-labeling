...
if(isset($_POST["atualiza"])) {
  ...
  $sql = "UPDATE images SET auditado=$audit, bichomineiro=$doenca[0], ferrugem=$doenca[1], phoma=$doenca[2], cercosporiose=$doenca[3], severidade=$severidade, observacao='$nota' WHERE id=$img_id";
...
$sql_query = "SELECT id, auditado, bichomineiro, ferrugem, phoma, cercosporiose, severidade, observacao FROM images WHERE id=$img_id";
$sql_ret_all = $mysqli->query($sql_query) or die($mysqli->error);
